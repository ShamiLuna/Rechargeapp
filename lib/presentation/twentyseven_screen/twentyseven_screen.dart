...
class TwentysevenScreen extends GetWidget<TwentysevenController> {
  const TwentysevenScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the twentyeightScreen when the action is triggered.
  onTapTwo() {
    Get.offNamed(
      AppRoutes.twentyeightScreen,
    );
  }
}
