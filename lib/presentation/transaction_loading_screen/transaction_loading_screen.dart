...
class TransactionLoadingScreen extends GetWidget<TransactionLoadingController> {
  const TransactionLoadingScreen({Key? key}) : super(key: key);
  ...
  /// Section Widget
  Widget _buildTransactionLoadingSection() {
                ...
                onTapTwo();
                  ...
                  child: SizedBox(height: 151,
                      ...
                      child: Stack(alignment: Alignment.bottomLeft,
                          children: [
                            CustomImageView(imagePath: ImageConstant.imgGroup2,
                                height: 46,
                                width: 254,
  ...
  /// Navigates to the transactionSuccesScreen when the action is triggered.
  onTapTwo() {
    Get.offNamed(AppRoutes.transactionSuccesScreen,);
  }
}
