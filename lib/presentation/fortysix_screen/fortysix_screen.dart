...
class FortysixScreen extends GetWidget<FortysixController> {
  const FortysixScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the fortysevenScreen when the action is triggered.
  onTapSendMoney() {
    Get.toNamed(
      AppRoutes.fortysevenScreen,
    );
  }
}
