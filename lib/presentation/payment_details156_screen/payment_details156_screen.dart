...
class PaymentDetails156Screen extends GetWidget<PaymentDetails156Controller> {
  const PaymentDetails156Screen({Key? key}) : super(key: key);
                      ...
                      Container(
                          ...
                          child:
                            ...
                            CustomElevatedButton(
                                ...
                                buttonTextStyle:
                                    CustomTextStyles.titleSmallGray10001,
                                onPressed: () {
  ...
  Widget _buildSendMoney() {
    return CustomElevatedButton(
        ...
        margin: EdgeInsets.only(left: 25, right: 25, bottom: 58),
        onPressed: () {
          onTapSendMoney();
        });
  }
  ...
  /// Navigates to the paymentPinfiftysevenScreen when the action is triggered.
  onTapSendMoney() {
    Get.toNamed(
