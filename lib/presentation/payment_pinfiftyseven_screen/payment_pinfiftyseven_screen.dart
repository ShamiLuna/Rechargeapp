...
class PaymentPinfiftysevenScreen
    extends GetWidget<PaymentPinfiftysevenController> {
  const PaymentPinfiftysevenScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the transactionLoading158Screen when the action is triggered.
  onTapConfirm() {
    Get.toNamed(
