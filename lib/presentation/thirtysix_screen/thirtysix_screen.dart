...
class ThirtysixScreen extends GetWidget<ThirtysixController> {
  const ThirtysixScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the frame33752Screen when the action is triggered.
  onTapConfirm() {
    Get.toNamed(
      AppRoutes.frame33752Screen,
    );
  }
}
