...
class TransactionLoading158Screen
    extends GetWidget<TransactionLoading158Controller> {
  const TransactionLoading158Screen({Key? key}) : super(key: key);
  ...
  /// Navigates to the transactionSucces159Screen when the action is triggered.
  onTapTwo() {
    Get.offNamed(
