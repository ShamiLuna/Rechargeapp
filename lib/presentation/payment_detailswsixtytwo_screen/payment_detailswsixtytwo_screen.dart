...
class PaymentDetailswsixtytwoScreen
    extends GetWidget<PaymentDetailswsixtytwoController> {
  const PaymentDetailswsixtytwoScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the paymentPinwsixtythreeScreen when the action is triggered.
  onTapSendMoney() {
    Get.toNamed(
