import '../manual_verification155_screen/widgets/userprofile4_item_widget.dart';
import 'controller/manual_verification155_controller.dart';
import 'models/userprofile4_item_model.dart';
import 'package:faz/core/app_export.dart';
import 'package:flutter/material.dart';

class ManualVerification155Screen
    extends GetWidget<ManualVerification155Controller> {
  const ManualVerification155Screen({Key? key}) : super(key: key);
  ...
  Widget _buildUserProfile() {
    return Obx(() => ListView.separated(
        ...
        itemCount: controller.manualVerification155ModelObj.value
            .userprofile4ItemList.value.length,
        itemBuilder: (context, index) {
          Userprofile4ItemModel model = controller.manualVerification155ModelObj
  ...
  /// Navigates to the paymentDetails156Screen when the action is triggered.
  onTapUserProfile() {
    Get.toNamed(AppRoutes.paymentDetails156Screen);
  }
