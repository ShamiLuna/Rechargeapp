import '../manual_verification_wsixtyone_screen/widgets/userprofile1_item_widget.dart';
import 'controller/manual_verification_wsixtyone_controller.dart';
import 'models/userprofile1_item_model.dart';
import 'package:faz/core/app_export.dart';
import 'package:flutter/material.dart';

class ManualVerificationWsixtyoneScreen
    extends GetWidget<ManualVerificationWsixtyoneController> {
  const ManualVerificationWsixtyoneScreen({Key? key}) : super(key: key);
  ...
  /// Section Widget
  Widget _buildPaymentMethodRow3() {
  ...
  Widget _buildUserProfile() {
    return Obx(() => ListView.separated(
        ...
        itemCount: controller.manualVerificationWsixtyoneModelObj.value
            .userprofile1ItemList.value.length,
        itemBuilder: (context, index) {
          Userprofile1ItemModel model = controller
              .manualVerificationWsixtyoneModelObj
              .value
  ...
  /// Navigates to the paymentDetailswsixtytwoScreen when the action is triggered.
  onTapUserProfile() {
    Get.toNamed(AppRoutes.paymentDetailswsixtytwoScreen);
  }
