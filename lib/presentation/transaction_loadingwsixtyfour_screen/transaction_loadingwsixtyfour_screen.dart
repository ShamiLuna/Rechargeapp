...
class TransactionLoadingwsixtyfourScreen
    extends GetWidget<TransactionLoadingwsixtyfourController> {
  const TransactionLoadingwsixtyfourScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the transactionSucceswsixtyfiveScreen when the action is triggered.
  onTapTwo() {
    Get.offNamed(
