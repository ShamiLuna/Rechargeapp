import '../thirteen_screen/widgets/userprofile2_item_widget.dart';
...
class ThirteenScreen extends GetWidget<ThirteenController> {
  ...
  Widget _buildUserProfile() {
    return Obx(() => ListView.separated(
        ...
        itemCount:
            controller.thirteenModelObj.value.userprofile2ItemList.value.length,
        itemBuilder: (context, index) {
          Userprofile2ItemModel model = controller
              .thirteenModelObj.value.userprofile2ItemList.value[index];
          return Userprofile2ItemWidget(model, onTapUserProfile: () {
            onTapUserProfile();
          });
        }));
  }
