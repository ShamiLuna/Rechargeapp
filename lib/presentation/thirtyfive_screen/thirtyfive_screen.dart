...
class ThirtyfiveScreen extends GetWidget<ThirtyfiveController> {
  const ThirtyfiveScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the thirtysixScreen when the action is triggered.
  onTapSendMoney() {
    Get.toNamed(
      AppRoutes.thirtysixScreen,
    );
  }
}
