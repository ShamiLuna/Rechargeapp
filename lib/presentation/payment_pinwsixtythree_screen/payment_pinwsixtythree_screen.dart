...
class PaymentPinwsixtythreeScreen
    extends GetWidget<PaymentPinwsixtythreeController> {
  const PaymentPinwsixtythreeScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the transactionLoadingwsixtyfourScreen when the action is triggered.
  onTapConfirm() {
    Get.toNamed(
