...
import 'package:faz/presentation/twentynine_dialog/twentynine_dialog.dart';
import 'package:faz/presentation/twentynine_dialog/controller/twentynine_controller.dart';

class TwentyeightScreen extends GetWidget<TwentyeightController> {
  const TwentyeightScreen({Key? key}) : super(key: key);
  ...
  /// Displays a dialog with the [TwentynineDialog] content.
  onTapDone() {
    Get.dialog(AlertDialog(
      backgroundColor: Colors.transparent,
      contentPadding: EdgeInsets.zero,
      insetPadding: const EdgeInsets.only(left: 0),
      content: TwentynineDialog(
        Get.put(
          TwentynineController(),
        ),
      ),
    ));
  }
